...
#docker run $run_flags $velvet_cont velveth out_velvet 29 -shortPaired -fastq.gz -separate SRR6166481_sub_hitting.fastq.1.gz SRR6166481_sub_hitting.fastq.2.gz
