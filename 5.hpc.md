...
NOTE: to run the examples of this episode you need access to a HPC system with [Shifter](https://github.com/NERSC/shifter) installed.
In alternative, feel free to just read through.
